...
// 7. Using the module pattern, design a toaster.
	//	Use your creativity here and think about what you want your users
	//	to be able to access on the outside of your toaster
	//	vs what you don't want them to be able to touch.
...
// [EXTRA CREDIT]
	...
	// Think about what actions you can control in the game
	//	and other aspects you can't control directly
	//  (example: you can only affect your health indirectly by eating a mushroom).
	// If you are not familiar with Super Mario,
	//	choose another simple game for this example.
